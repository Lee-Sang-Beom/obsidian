...
![[Pasted image 20240304091701.png]]
...
- 출력되는 화면은 아래와 같다.
![[Pasted image 20240304092943.png]]
...
![[Pasted image 20240304095014.png]]
...
- waterfalls를 피하는 일반적인 방법 중 하나는 모든 데이터 요청을 병렬로 시작하는 것이다.
...
이러한 패턴을 사용하면 다음을 할 수 있습니다:

- 모든 데이터 가져오기를 동시에 시작하여 성능 향상을 이끌어낼 수 있습니다.
- 어떤 라이브러리나 프레임워크에도 적용할 수 있는 네이티브 JavaScript 패턴을 사용할 수 있습니다.

그러나 이 JavaScript 패턴만을 의존하는 경우에는 한 가지 단점이 있습니다: 다른 모든 데이터 요청보다 하나의 데이터 요청이 느린 경우 어떻게 될까요?