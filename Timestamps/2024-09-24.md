...
#### Work
---
- [ ] (1:30) SelectBox -> FormControl padding영역 클릭 시 SelectBox에서 발생하는 이벤트가 발생할 수 있도록 하기 위한 로직 작성 (padding 영역 dropdown open되지 않는 문제 때문)
- [ ] (1:00) ppladmdstStts 화면 좌측하단 범례영역 경계값 계산(DIVIDE10)
- [ ] (1:00) APopulationLegend 컴포넌트 구현
- [ ] (1:30) ppladmdstStts 데이터 그룹핑 api 생성
- [ ] (0:30) tonggeom 중심 point 계산식수정
- [ ] (2:30) ppladmdstStts 그룹핑데이터 및 관리자페이지 등록 tonggeom 총인구수, 총세대수 연동
