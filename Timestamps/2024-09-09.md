...
- [x] (0:50) 지도로 보는 김해 - 백엔드 / DB 테이블 카테고리별 마커 URL INSERT 작업
- [ ] (0:30) 지도로 보는 김해 - 프론트엔드 / infowindow 스타일 분리 (2개 케이스)
- [ ] (0:40) 지도로 보는 김해 - 프론트엔드 / zoomlevl 변경에 따른 gimhae geom polygon off 기능 수정 (항상 사라지지 않도록)  및 백업
