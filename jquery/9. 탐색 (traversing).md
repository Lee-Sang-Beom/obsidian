...
$('#root').addClass('s').removeClass('s').children().addClass('s').removeClass('s').first().addClass('s').removeClass('s').next().addClass('s').removeClass('s').prev().addClass('s').removeClass('s').parent().addClass('s').removeClass('s').find('li').addClass('s').removeClass('s').first().addClass('s').removeClass('s').end().addClass('s').removeClass